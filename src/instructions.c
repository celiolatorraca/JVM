...
int pc; /*todo tirar isso daqui, coloquei pra pararem os erros */
...
void executeInstruction(u1 opcode){
	...
	printf("\nvai executar %s", opcode_tmp.desc);
...
void initializeInstr()
{
	...
	instr[0xba] = NULL; /*funct_nao_utilizada;*/
	...
	instr[0xc7] = NULL; /* funct_ifnonull; todo dava erro */
...
int funct_aconst_null(){
	push ( NULL );  /*todo  Definir e mudar para constante */
